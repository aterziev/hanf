...
<form action="<?php echo r3('index.php?ext='.\GApp3::instance()->extension.'&cont='.\GApp3::instance()->controller.'&act='.\GApp3::instance()->action); ?>" method="post" name="admin_form" id="admin_form" enctype="multipart/form-data" class="ui form">
	{VIEW}
</form>